...
class Loader
{
	...
	public function view($view, $array_extract = array())
	{
		if (!is_string($view)) {
			...
			if (is_readable(\UltraMVC\UltraMVCBootstrap::ROOT_DIR.'/Library/Views/'.$view.'.php')) {
				include(\UltraMVC\UltraMVCBootstrap::ROOT_DIR.'/Library/Views/'.$view.'.php');
			} elseif (is_readable(\UltraMVC\UltraMVCBootstrap::ROOT_DIR.'/Application/Views/'.$view.'.php')) {
				include(\UltraMVC\UltraMVCBootstrap::ROOT_DIR.'/Application/Views/'.$view.'.php');
			} else {
